    ...
    enum SideMenuNavigation: String, Identifiable {
        ...
        @ViewBuilder
        func destinationView(authManager: AuthManager) -> some View {
            // Updated to use proper views
            switch self {
            case .updateProfile:
        ...
        // Check if the destination needs AuthManager
        var needsAuthManager: Bool {
            switch self {
            case .updateProfile:
                return true
            default:
    ...
    struct SideMenuView: View {
        ...
        var body: some View {
            ...
            .sheet(item: $selectedDestination) { destination in
                if destination.needsAuthManager {
                    destination.destinationView(authManager: authManager)
